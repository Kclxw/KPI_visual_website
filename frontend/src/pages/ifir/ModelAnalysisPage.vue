<template>
  <div class="page-container">
    <div class="page-header">
      <h1>IFIR Model分析</h1>
      <p class="description">按Model维度分析IFIR表现与Top Issue</p>
    </div>
...
import ModelCard from '@/components/kpi/ifir/model/ModelCard.vue'
import SummaryBlockD from '@/components/kpi/common/SummaryBlockD.vue'
import { getIfirOptions, analyzeIfirModel, downloadIfirModelReport, type IfirOptions, type ModelAnalyzeResponse } from '@/api/ifir'
...
const options = ref<IfirOptions | null>(null)
...
const handleAnalyze = async () => {
  ...
  try {
    const result = await analyzeIfirModel({
...
const handleExportReport = async () => {
  ...
  try {
    ...
    const fallback = buildReportFilename('IFIR', 'Model', selectedModels.value, dateRange.value)

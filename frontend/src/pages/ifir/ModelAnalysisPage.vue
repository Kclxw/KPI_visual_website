...
import { Search, Monitor, Loading } from '@element-plus/icons-vue'
...
import { getIfirOptions, analyzeIfirModel, type IfirOptions, type ModelAnalyzeResponse } from '@/api/ifir'

  ...
  <div class="page-container">
    ...
    <div class="filter-panel">
      <div class="filter-row">
        ...
        <div class="filter-item">
          <span class="filter-label">Segment <el-tag size="small" type="danger">必选</el-tag></span>
          <el-select
            v-model="selectedSegments"
            multiple
            collapse-tags
            collapse-tags-tooltip
            placeholder="请选择Segment"
            style="width: 240px"
...
const hasData = computed(() => segmentOptions.value.length > 0)

// 分析状态
const analyzing = ref(false)
const showResult = ref(false)
const activeIndex = ref(0)
const analyzeResult = ref<SegmentAnalyzeResponse | null>(null)
...
const handleAnalyze = async () => {
  ...
  try {
    const result = await analyzeIfirSegment({
